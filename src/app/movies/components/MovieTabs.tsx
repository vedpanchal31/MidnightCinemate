...
export default function MovieTabs({ onTabChange }: MovieTabsProps) {
  ...
  const tabs = [
    {
      id: "now-playing" as TabType,
      label: "Now Playing",
      count: nowPlayingMovies.length,
    },
    {
      id: "hollywood" as TabType,
      label: "Hollywood",
      count: hollywoodMovies.length,
    },
    {
      id: "bollywood" as TabType,
      label: "Bollywood",
  ...
  const isLoading =
    (activeTab === "now-playing" && isNowPlayingLoading) ||
    isNowPlayingFetching ||
    (activeTab === "hollywood" && isHollywoodLoading) ||
    isHollywoodFetching ||
    (activeTab === "bollywood" && isHindiLoading) ||
    isHindiFetching;
      ...
      <div className="space-y-6">
        <div className="text-center space-y-2">
          <h3
            ...
            style={{
              backgroundImage: "linear-gradient(to right, #E50914, #8b0000)",
          ...
          <p className="text-muted-foreground text-lg">
            Discover amazing films from around the world
          </p>
        </div>
        ...
        <div className="relative">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to right, rgba(229, 9, 20, 0.1), rgba(0, 0, 0, 0), rgba(229, 9, 20, 0.1))",
            }}
          />
              ...
              >
                ...
                <div className="relative z-10 space-y-2">
                  ...
                  <div
                    ...
                    ${activeTab === tab.id ? "text-white/90" : "text-zinc-500"}
                  `}
                  >
                    <span
                      className={`
                ...
                <div className="absolute inset-0 bg-linear-to-t from-primary/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-xl" />
              </button>
            ))}
          </div>
            ...
            {currentMovies.map((movie) => (
              ...
              >
                <div className="aspect-2/3 relative">
                  ...
                  {/* Enhanced overlay */}
                  <div className="absolute inset-0 bg-linear-to-t from-black/95 via-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500">
                    <div
                      className="absolute inset-0"
                      style={{
                        background:
                          "linear-gradient(to bottom right, rgba(229, 9, 20, 0.2), transparent)",
                      }}
                    />
                  </div>
                  ...
                  <div className="absolute inset-0 p-4 flex flex-col justify-end opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-4 group-hover:translate-y-0">
                    <div className="space-y-3">
                      ...
                      <Button
                        asChild
                        className="w-full bg-primary hover:bg-primary/90 text-white font-bold py-3 rounded-xl shadow-lg"
                      >
