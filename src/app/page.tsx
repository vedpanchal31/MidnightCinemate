    ...
    <main className="min-h-screen bg-background text-foreground flex flex-col items-center justify-center p-8 text-center relative overflow-hidden">
      ...
      <div className="z-10 max-w-4xl space-y-8 animate-in fade-in zoom-in duration-700">
        ...
        <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto">
          Experience movies like never before. Premium seating, real-time availability, and a cinematic booking journey.
        </p>

        <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
          <Button asChild size="lg" className="text-lg px-8 h-12 rounded-full bg-primary hover:bg-primary/90 shadow-[0_0_30px_-5px_var(--primary)] text-white">
            <Link href="/movies">Book Now</Link>
          </Button>
          <Button asChild variant="outline" size="lg" className="text-lg px-8 h-12 rounded-full border-white/10 hover:bg-white/5 backdrop-blur-sm">
      ...
      <div className="absolute bottom-10 left-0 w-full flex justify-center gap-8 opacity-30">
        <div className="text-sm font-mono tracking-widest text-[#E50914]">NOW SHOWING</div>
        <div className="text-sm font-mono tracking-widest text-[#3B82F6]">IMAX 3D</div>
        <div className="text-sm font-mono tracking-widest text-[#22C55E]">DOLBY ATMOS</div>
      </div>
    </main>
  );
}
